...
extension UIViewController {
    ...
    func goToTableView()  {
        ...
        let eventsViewController = UIStoryboard(name: "Main", bundle: nil)
        let EventsViewController = eventsViewController.instantiateViewController(identifier: "EventsViewController")
    ...
    func goToDetails () {
        ...
        let DetailsViewController = detailsViewController.instantiateViewController(identifier: "DetailsViewController")
